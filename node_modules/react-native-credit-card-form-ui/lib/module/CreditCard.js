...
import { View, Text, StyleSheet, Image, Animated, TouchableOpacity, TouchableWithoutFeedback, Keyboard, PixelRatio } from 'react-native'; // import CreditCardType from 'credit-card-type';
...
const CreditCard = /*#__PURE__*/React.forwardRef(({
  ...
  const rotate = React.useCallback(() => {
    ...
    Animated.parallel([Animated.timing(frontOpacityRef, fadeAnimationConfig(!isFrontActive)), Animated.timing(backOpacityRef, fadeAnimationConfig(isFrontActive)), Animated.timing(rotationValue, rotateAnimationConfig(isFrontActive))]).start(() => {
      const newActiveSide = isFrontActive ? CardSideEnum.BACK : CardSideEnum.FRONT;
  ...
  return /*#__PURE__*/React.createElement(TouchableWithoutFeedback, {
  ...
  }, /*#__PURE__*/React.createElement(CardSide, {
    ...
    animation: "slideInRight",
    duration: 400
  }, cardConfig.brandName)), /*#__PURE__*/React.createElement(Image, {
    source: Images.chip,
    style: styles.imageChip
  }), /*#__PURE__*/React.createElement(View, null, /*#__PURE__*/React.createElement(CardInput, {
  ...
  }, labels.holder), /*#__PURE__*/React.createElement(CardInput, {
    placeholderTextColor: placeholderTextColor,
    name: "holder",
    ...
    style: [styles.textLabel, textStyle]
  }, labels.expiration), /*#__PURE__*/React.createElement(CardInput, {
    placeholderTextColor: placeholderTextColor,
    name: "expiration",
    ...
    style: [styles.textLabel, textStyle]
  }, labels.cvv), /*#__PURE__*/React.createElement(CardInput, {
    placeholderTextColor: placeholderTextColor,
    name: "cvv",
